...
public class TransactionRepositoryImplementation implements TransactionRepository{
    ...
    private static final String SQL_CREATE = "INSERT INTO TRANSACTIONS (TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE) VALUES(NEXTVAL('ET_TRANSACTIONS_SEQ'), ?, ?, ?, ?, ?)";
